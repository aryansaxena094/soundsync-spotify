...
public class GetPlaylistControllerForUpdate extends HttpServlet {

	Logger logger = Logger.getLogger(GetPlaylistControllerForUpdate.class.getName());
	private static final long serialVersionUID = 1L;

	DBUtil dbutil = new DBUtil();
	
	public GetPlaylistControllerForUpdate() {
		
	}
	public GetPlaylistControllerForUpdate(DBUtil dbutil) {
		this.dbutil=dbutil;
	}
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		logger.log(Level.INFO,"-------------play list get for update controller entered-------------");
